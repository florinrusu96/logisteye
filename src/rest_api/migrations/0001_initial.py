    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'admin'), ('DELIVERY', 'delivery')], default='DELIVERY', max_length=20)),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rest_api.company')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='user',
            name='assigned_area',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='rest_api.area'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
